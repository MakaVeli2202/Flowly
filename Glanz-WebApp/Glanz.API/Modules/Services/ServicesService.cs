...
using IAutoTranslationService = Glanz.API.Services.IAutoTranslationService;
using ILocalizationTextResolver = Glanz.API.Services.ILocalizationTextResolver;
using LocalizedText = Glanz.API.Services.LocalizedText;
using ServiceModel = Glanz.API.Models.Service;

namespace Glanz.API.Modules.Services
{
