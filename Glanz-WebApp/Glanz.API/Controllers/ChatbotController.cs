...
namespace Glanz.API.Controllers
{
    ...
    public class ChatbotController : ControllerBase
    {
        ...
        {
            ["hello"]         = "Hi! I'm the Glanz assistant. I can help with bookings, services, pricing, and cancellations. What can I help you with?",
            ["hi"]            = "Hi! I'm the Glanz assistant. How can I help you today?",
            ...
            ["contact"]       = "For urgent inquiries, please contact us at support@glanz.qa.",
        ...
        private async Task<string> BuildSystemPromptAsync()
        {
            ...
            sb.AppendLine("You are a helpful assistant for Glanz, a professional car detailing marketplace in Qatar.");
            sb.AppendLine("You answer customer questions about services, pricing, bookings, cancellations, and schedules.");
            sb.AppendLine("Be friendly, concise, and professional. Answer only questions about Glanz services.");
            sb.AppendLine("If you don't know something, say so and suggest they contact support at support@glanz.qa.");
            sb.AppendLine();
        ...
        private static string GetCannedAnswer(string message)
        {
            ...
            return "I'm not sure about that. For more help, contact us at support@glanz.qa or check the Packages and My Bookings screens in the app.";
        }
    }
}
