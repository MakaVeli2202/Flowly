...
namespace Glanz.API.Controllers
{
    ...
    public class NotificationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendTestNotification([FromBody] SendTestNotificationDto dto)
        {
            ...
            await _expoPush.SendAsync(customer.ExpoPushToken, "Glanz", dto.Message, new { type = "SpecialOffer" });
        ...
        private async Task<IQueryable<Glanz.API.Models.Notification>> BuildScopedQuery(int userId)
        {
