...
namespace Glanz.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private Task<Glanz.API.Models.Staff?> GetStaffFromContextAsync(int id) =>
            HttpContext.RequestServices.GetRequiredService<Glanz.API.Data.AppDbContext>().Staff.FindAsync(id).AsTask();
        private Task<Glanz.API.Models.User?> GetUserFromContextAsync(int id) =>
            HttpContext.RequestServices.GetRequiredService<Glanz.API.Data.AppDbContext>().Users.FindAsync(id).AsTask();
        private Task SaveContextAsync() =>
            HttpContext.RequestServices.GetRequiredService<Glanz.API.Data.AppDbContext>().SaveChangesAsync();
    }
}
