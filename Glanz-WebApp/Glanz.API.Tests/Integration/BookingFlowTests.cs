...
namespace Glanz.API.Tests.Integration
{
    ...
    public class BookingFlowTests : IClassFixture<BookingFlowTests.GlanzWebAppFactory>
    {
        public class GlanzWebAppFactory : WebApplicationFactory<Program>, IDisposable
        {
            // Keep the connection alive so the in-memory SQLite DB persists for the factory lifetime
            private readonly SqliteConnection _connection = new("DataSource=:memory:");

            public GlanzWebAppFactory() => _connection.Open();
            ...
            protected override void ConfigureWebHost(IWebHostBuilder builder)
            {
                ...
                builder.ConfigureAppConfiguration((_, cfg) =>
                {
                    cfg.AddInMemoryCollection(new Dictionary<string, string?>
                    {
                        ...
                        ["JwtSettings:Issuer"]           = "GlanzTest",
                        ["JwtSettings:Audience"]         = "GlanzTest",
        ...
        private readonly GlanzWebAppFactory _factory;

        public BookingFlowTests(GlanzWebAppFactory factory)
        {
            _factory = factory;
        }
