...
const UI_BY_LANG = {
  en: {
    ...
    intro: 'At Glanz, we respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, disclose, and safeguard your information when you visit our website, use our services, or interact with us.',
  ...
  ar: {
    ...
    intro: 'في Glanz نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية. توضح هذه السياسة كيف نجمع معلوماتك ونستخدمها ونفصح عنها ونحميها عند زيارة موقعنا أو استخدام خدماتنا أو التواصل معنا.',
  ...
  de: {
    ...
    intro: 'Bei Glanz respektieren wir Ihre Privatsphare und schutzen Ihre personenbezogenen Daten. Diese Datenschutzerklarung beschreibt, wie wir Informationen erheben, verwenden, weitergeben und schutzen, wenn Sie unsere Website besuchen oder unsere Dienste nutzen.',
