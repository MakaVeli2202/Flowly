...
function CookieConsent({ privacyHref = "#", className = "" }) {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/70 dark:bg-black/80"
    >
      <div
      ...
      >
        <div className="mx-auto mb-4 sm:mb-5 h-16 w-16 drop-shadow-sm">
          <svg
            ...
            viewBox="12.439992904663086 20.160001754760742 231.07997131347656 206.8550567626953"
          ...
          >
            <g fill="none" stroke="none">
              <g transform="scale(4,4)">
                ...
                <path d="M48.14,12.51c0.18,0.3 0.51,0.49 0.86,0.49c0.04,0 0.08,0 0.12,0c0.39,-0.05 0.72,-0.32 0.84,-0.69l1,-3.16c0.03,-0.1 0.05,-0.2 0.05,-0.3v-2.79c0,-0.46 -0.23,-1.02 -1.35,-1.02c-0.62,0 -1.56,0.05 -2.36,0.19c-0.57,0.1 -2.29,0.4 -2.29,1.77c0,0.18 0.05,0.36 0.14,0.51l3,5zM49,7.04v1.63l-0.28,0.9l-1.4,-2.33c0.46,-0.1 1.12,-0.17 1.68,-0.21z" fill="#1a2c3d"></path>
                <path d="M55.11,14.49c0.16,0.03 0.31,0.04 0.47,0.04c0.67,0 1.34,-0.24 2,-0.72c0.33,-0.24 0.48,-0.65 0.39,-1.04c-0.16,-0.69 -0.82,-2.96 -2.39,-3.39c-0.55,-0.15 -1.39,-0.12 -2.3,0.83c-0.06,0.06 -0.11,0.12 -0.15,0.19l-0.62,1.1c-0.19,0.33 -0.17,0.75 0.04,1.06c0.78,1.13 1.62,1.76 2.56,1.93zM54.8,11.51c0.17,-0.16 0.26,-0.19 0.26,-0.2c0.18,0.07 0.49,0.57 0.74,1.19c-0.18,0.05 -0.29,0.03 -0.34,0.02c-0.27,-0.05 -0.57,-0.25 -0.88,-0.61l0.23,-0.4z" fill="#1a2c3d"></path>
                <path d="M36,35c-1.65,0 -3,1.35 -3,3c0,1.65 1.35,3 3,3c1.65,0 3,-1.35 3,-3c0,-1.65 -1.35,-3 -3,-3zM36,39c-0.55,0 -1,-0.45 -1,-1c0,-0.55 0.45,-1 1,-1c0.55,0 1,0.45 1,1c0,0.55 -0.45,1 -1,1z" fill="#1a2c3d"></path>
                <circle cx="29.5" cy="46.5" r="1.5" fill="#1a2c3d"></circle>
                <circle cx="12.5" cy="38.5" r="1.5" fill="#1a2c3d"></circle>
                <circle cx="34.5" cy="29.5" r="1.5" fill="#1a2c3d"></circle>
        ...
        <div className="text-center mb-5">
          <h2
            id="cookie-title"
            className="text-lg sm:text-xl font-bold text-neutral-700 dark:text-neutral-100"
          >
            Freshly Baked Cookies!
          </h2>
          <p className="mt-2 text-sm sm:text-base leading-relaxed text-neutral-600 dark:text-neutral-300">
            Our site uses cookies to provide you with a smooth and personalized experience.
            By clicking "Accept", you agree to our{" "}
            <a
              href={privacyHref}
              className="font-semibold underline text-amber-700 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 rounded-sm"
            >
              Privacy Policy
            </a>.
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <button
            type="button"
            className="relative inline-flex items-center justify-center px-4 py-2.5 sm:px-5 font-semibold text-white bg-amber-700 hover:bg-amber-800 active:bg-amber-900 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 transition-colors w-full sm:w-auto"
          ...
          <button
            type="button"
            className="relative inline-flex items-center justify-center px-4 py-2.5 sm:px-5 font-semibold bg-neutral-200 text-neutral-800 hover:bg-neutral-300 active:bg-neutral-400 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700 dark:active:bg-neutral-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500 transition-colors w-full sm:w-auto"
