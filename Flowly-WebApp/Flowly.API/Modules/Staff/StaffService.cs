...
using StaffModel = Flowly.API.Models.Staff;

namespace Flowly.API.Modules.Staff
{
    public class StaffService : IStaffService
    {
        ...
        public async Task<(List<object>? Conflicts, string? Error)> GetScheduleConflictsAsync(int staffId, string workingDays, string shiftStart, string shiftEnd)
        {
            ...
            var upcomingBookings = await _context.Bookings
                .Where(b => b.AssignedWorkerId == staffId
                    ...
                    && b.Status != Flowly.API.Models.BookingStatus.Cancelled
                    && b.Status != Flowly.API.Models.BookingStatus.Completed)
                .ToListAsync();
        ...
        public async Task<object> GetPaySlipSettingsAsync()
        {
            ...
            return new
            {
                companyName    = Get("payslip.companyName")    ?? "Flowly",
