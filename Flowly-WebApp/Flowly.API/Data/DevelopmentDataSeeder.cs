...
public static class DevelopmentDataSeeder
{
    public static async Task SeedAsync(IServiceProvider sp, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        var adminEmail    = configuration["AdminUser:Email"]     ?? "admin@flowly.app";
        ...
        var workers = new List<Staff>
        {
            new()
            {
                ...
                Email          = "ahmed.mansoori@flowly.app",
        ...
        await db.SystemSettings.AddRangeAsync(new List<SystemSetting>
        {
            ...
            new() { Key = "payslip.companyName",         Value = "Flowly", UpdatedAt = now },
            ...
            new() { Key = "payslip.companyEmail",      Value = "info@flowly.app", UpdatedAt = now },
