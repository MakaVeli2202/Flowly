...
namespace Flowly.API.Services
{
    ...
    public class SmtpEmailService : IEmailService
    {
        ...
        {
            var subject = "Verify your Flowly account";
            var html = $"""
                <div style="font-family:sans-serif;max-width:480px;margin:0 auto">
                  <h2 style="color:#c8a96b">Verify your email</h2>
                  <p>Hi {WebUtility.HtmlEncode(toName)},</p>
                  <p>Use the code below to verify your Flowly account. It expires in 24 hours.</p>
        ...
        {
            var subject = "Reset your Flowly password";
            var html = $"""
                <div style="font-family:sans-serif;max-width:480px;margin:0 auto">
        ...
        public Task SendRawAsync(string toEmail, string toName, string subject, string htmlBody)
            => SendAsync(toEmail, subject, htmlBody, devLogMessage: $"[EMAIL] To: {toEmail} ({toName}) Subject: {subject}");
        ...
        private async Task SendAsync(string toEmail, string subject, string htmlBody, string devLogMessage)
        {
            ...
            var from     = _config["Email:FromAddress"]  ?? "noreply@flowly.app";
            var fromName = _config["Email:FromName"]     ?? "Flowly";
