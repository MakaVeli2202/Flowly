...
export const authAPI = {
  ...
  getScheduleConflicts: async (workerId, workingDays, shiftStart, shiftEnd) => {
    const response = await apiClient.get(`/Auth/workers/${workerId}/schedule-conflicts`, {
      params: { workingDays, shiftStart, shiftEnd },
    });
    return response.data;
  },
