...
export const crmAPI = {
  ...
  bulkMessage: async (customerIds, message, channel = 'push', segment) => withRetry(async () => {
    const response = await apiClient.post('/Crm/customers/bulk-message', { customerIds, message, channel, segment });
    return response.data;
  }),
