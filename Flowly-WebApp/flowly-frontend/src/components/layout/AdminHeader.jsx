...
import { LayoutDashboard, Bell, LogOut, Sun, Moon, Globe, ChevronDown, CheckCheck, Menu, X, BookOpen, Users, Calendar, Clock, DollarSign, MapPin, Settings, Wrench, BarChart2, Package, UserCheck, Play, Pause, Car, AlertTriangle, Gift, Tag, Star, TrendingUp, Building2, CreditCard, ShoppingCart, Layers, Truck, Search, Briefcase, RefreshCw, Receipt, Euro, Megaphone } from 'lucide-react';
...
export function AdminHeader({ theme, onToggleTheme }) {
  ...
  const ADMIN_LINKS = [
    ...
    { to: '/admin/org-settings',        labelKey: 'navbar.orgSettings', icon: Building2 },
    { to: '/admin/billing',             labelKey: 'navbar.billing',     icon: CreditCard },
    ...
    { to: '/admin/recurring-bookings',  labelKey: 'navbar.recurringBookings', icon: RefreshCw },
    { to: '/admin/rksv',                labelKey: 'navbar.rksv',              icon: Receipt },
    { to: '/admin/sepa',                labelKey: 'navbar.sepa',              icon: Euro },
    { to: '/admin/campaigns',           labelKey: 'navbar.campaigns',         icon: Megaphone },
  ];

  const ADMIN_GROUPS = [
    {
      titleKey: 'navbar.operations',
      links: ['/admin/bookings', '/admin/workers/schedule', '/admin/workers/management', '/admin/live-map', '/admin/analytics', '/admin/payroll', '/admin/pos', '/admin/recurring-bookings', '/admin/campaigns'],
    },
    {
      titleKey: 'navbar.management',
      links: ['/admin', '/admin/staff', '/admin/settings', '/admin/org-settings', '/admin/billing', '/admin/purchase-orders', '/admin/resources', '/admin/corporate-accounts', '/admin/asset-search', '/admin/rksv', '/admin/sepa', '/admin/dev-settings', '/admin/translations'],
    },
  ];
