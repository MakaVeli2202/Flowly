...
export function TiltCard({
  ...
  const handlePointerMove = useCallback(
    (e) => {
      ...
      // Call additional onMouseMove if provided
      if (onMouseMove) {
        // Adjust the event to be like mousemove? We'll just call it with the original event.
        onMouseMove(e);
      }
    },
    [tiltLimit, scale, perspective, dir, spotlight, onMouseMove]
  );
