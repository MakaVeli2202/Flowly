/**
 * [MOCK] ChatbotScreen — AI assistant for Flowly mobile app.
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, {
        role: 'bot',
        text: "Sorry, I couldn't process that. Please try again or contact support@flowly.app.",
        id: Date.now() + 1,
        isError: true,
      }]);
    } finally {
      ...
      >
        ...
        <Animated.View entering={FadeIn.duration(400)} style={s.identityStrip}>
          ...
          <View>
            ...
            <Text style={s.identityTagline}>Flowly · Powered by Claude</Text>
          </View>
