...
export default function MyBookingsScreen({ navigation }) {
  ...
  const openGoogleReview = async () => {
    const url = loyalty?.googleReviewUrl || 'https://www.google.com/search?q=Flowly+Qatar+Google+review';
            ...
            {!loyalty.isGoogleReviewActivated && (
              <View style={s.reviewUnlockCard}>
                ...
                <Text style={s.reviewUnlockText}>
                  Rate Flowly on Google once to start the counter. Your next completed wash then begins the 3-slot reward cycle.
                </Text>
