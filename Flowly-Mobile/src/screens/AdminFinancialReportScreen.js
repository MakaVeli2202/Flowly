  ...
  return (
    <View style={styles.root}>
      <View style={[styles.header, headerStyle]}>
        <Text style={[styles.title, { opacity: headerOpacity }]}>{t('admin.reports.financial', 'Financial Reports')}</Text>
      </View>
      <ScrollView style={styles.scroll} onScroll={handleScroll} scrollEventThrottle={16}>
        <View style={styles.content}>
          ...
          <Text style={styles.message}>{t('admin.reports.comingSoon', 'Financial reports coming soon')}</Text>
        </View>
