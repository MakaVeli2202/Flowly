  ...
  return (
    <View style={styles.root}>
      <View style={[styles.header, headerStyle]}>
        <Text style={[styles.title, { opacity: headerOpacity }]}>{t('admin.skills.title', 'Worker Skills')}</Text>
      </View>
      <ScrollView style={styles.scroll} onScroll={handleScroll} scrollEventThrottle={16}>
        <View style={styles.content}>
          ...
          <Text style={styles.message}>{t('admin.skills.comingSoon', 'Skills management coming soon')}</Text>
        </View>
